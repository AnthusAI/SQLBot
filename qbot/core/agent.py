"""
Main QBot Agent for Core SDK

This module provides the main QBotAgent class that coordinates all core functionality.
"""
...
class QBotAgent:
    """
    Main QBot agent that coordinates all core functionality
...
class QBotAgentFactory:
    """Factory for creating QBot agents with different configurations"""
    
    @staticmethod
    def create_from_env(profile: Optional[str] = None, **overrides) -> QBotAgent:
        """
        Create QBot agent from environment variables
        ...
        Returns:
            Configured QBotAgent instance
        """
        config = QBotConfig.from_env(profile)
        ...
        return QBotAgent(config)
    
    @staticmethod
    def create_read_only(profile: Optional[str] = None) -> QBotAgent:
        """
        Create read-only QBot agent
        
        Args:
            profile: Optional profile name
            
        Returns:
            Read-only QBotAgent instance
        """
        return QBotAgentFactory.create_from_env(profile, read_only=True)
    
    @staticmethod
    def create_preview_mode(profile: Optional[str] = None) -> QBotAgent:
        """
        Create QBot agent in preview mode (compile only, don't execute)
        
        Args:
            profile: Optional profile name
            
        Returns:
            Preview-mode QBotAgent instance
        """
        return QBotAgentFactory.create_from_env(profile, preview_mode=True)
