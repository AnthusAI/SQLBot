"""
dbt integration for QBot Core SDK
...
class DbtExecutor:
    ...
    def _get_temp_directory(self) -> str:
        ...
        # Priority 1: .qbot/profiles/{profile}/models/temp/
        user_temp_dir = Path(f'.qbot/profiles/{profile_name}/models/temp')
        if user_temp_dir.parent.parent.parent.exists():  # Check if .qbot/profiles/{profile} exists
...
def cleanup_temp_files():
    ...
    profile_patterns = [
        ...
        '.qbot/profiles/*/models/temp/qbot_temp_*.sql',
        '.qbot/profiles/*/models/temp/*.sql'
    ]
