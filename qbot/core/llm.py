"""
LLM integration for QBot Core SDK
...
class LLMAgent:
    ...
    def _build_system_prompt(self) -> str:
        ...
        prompt = """You are QBot, a helpful database query assistant. You help users query their database using natural language.
...
def test_llm_basic(config: QBotConfig) -> bool:
    """
