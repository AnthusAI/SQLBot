"""
Command handling for QBot REPL interface
"""

import sys
from typing import Optional, Dict, Callable
from qbot.core import QBotAgent
...
class CommandHandler:
    ...
    def __init__(self, agent: QBotAgent, formatter: ResultFormatter):
        self.agent = agent
    ...
    def _cmd_help(self, args: str) -> bool:
        ...
        help_text = """
[bold magenta2]QBot Commands:[/bold magenta2]
...
[bold cyan]/status[/bold cyan] - Show QBot status and configuration
[bold cyan]/exit[/bold cyan] or [bold cyan]/quit[/bold cyan] - Exit QBot
