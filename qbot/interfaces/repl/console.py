"""
Main REPL console for QBot using Rich
"""
...
class QBotREPL:
    """Rich console REPL interface using QBot core SDK"""
    
    def __init__(self, agent: QBotAgent, console: Optional[Console] = None):
        """
        Initialize QBot REPL
...
def create_repl_from_args(args) -> QBotREPL:
    """
    Create QBot REPL from command line arguments
    
    Args:
        args: Parsed command line arguments
        
    Returns:
        Configured QBotREPL instance
    """
    # Create configuration
    config = QBotConfig.from_env(args.profile)
