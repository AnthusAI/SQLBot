...
def create_cli_parser():
    ...
    parser.add_argument('--textual', action='store_true', help='Use Textual TUI interface (default is text-based)')
    ...
    parser.add_argument('--web', action='store_true', help='Start web interface for SQLBot')
