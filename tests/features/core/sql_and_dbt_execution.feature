Feature: SQL and dbt Query Execution
  ...
  Scenario: Handle missing table errors
    ...
    Then QBot should detect the table doesn't exist
  ...
  Scenario: Handle permission errors
    ...
    Then QBot should handle any permission errors gracefully
  ...
  Scenario: Query timeout handling
    ...
    Then QBot should timeout gracefully after a reasonable period
  ...
  Scenario: Large result set handling
    ...
    Then QBot should handle the large result set efficiently
  ...
  Scenario: Multiple query execution
    ...
    Then QBot should execute each query in sequence
  ...
  Scenario: Query with parameters
    ...
    Then QBot should safely handle the parameters
  ...
  Scenario: Database connection recovery
    ...
    Then QBot should detect the connection issue
