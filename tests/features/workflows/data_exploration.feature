Feature: Data Exploration and Discovery
  ...
  Scenario: Explore table structure
    ...
    Then QBot should show me the table schema
  ...
  Scenario: Find related tables
    ...
    Then QBot should search table names and descriptions
  ...
  Scenario: Understand data relationships
    ...
    Then QBot should identify the relationship between these entities
  ...
  Scenario: Sample data exploration
    ...
    Then QBot should return a representative sample
  ...
  Scenario: Data quality assessment
    ...
    Then QBot should check for common data quality problems
  ...
  Scenario: Find recent data
    ...
    Then QBot should identify date/timestamp columns
  ...
  Scenario: Explore data patterns
    ...
    Then QBot should analyze the column distribution
  ...
  Scenario: Discover business rules
    ...
    Then QBot should analyze constraints and patterns
  ...
  Scenario: Find documentation
    ...
    Then QBot should look for schema comments and descriptions
  ...
  Scenario: Performance exploration
    ...
    Then QBot should provide information about table sizes
  ...
  Scenario: Historical data analysis
    ...
    Then QBot should identify date ranges across tables
